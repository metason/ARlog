...
class PlaneDetectionViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        ARlog.test("A plane detected after 2 seconds?", assert:
            { return self.sceneView.scene.rootNode.childNodes.count > 0 }, at: 2.0)
        ARlog.start(sceneView, sessionName: "PlaneDetection")
    }
