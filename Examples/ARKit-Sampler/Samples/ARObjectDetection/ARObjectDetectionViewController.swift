...
class ARObjectDetectionViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        ARlog.test("Any object detected after 3 seconds?", assert: { return self.latestResult != nil }, at: 3.0)
        ARlog.start(sceneView, sessionName: "ARObjectDetection")
...
//            print("best: ")
            ...
            ARlog.classifiedImage(label: best.identifier, confidence: best.confidence)
    ...
    private func performCoreML() {
        ...
        serialQueue.async {
            ...
            do {
                ...
                print(error)
                ARlog.error(error.localizedDescription)
                self.isPerformingCoreML = false
            }
        }
    }
